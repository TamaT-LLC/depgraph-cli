...
Issue #72でsnapshot create / list / show CLIとimmutable name schema v9、Issue #73でcompleted snapshot間のcanonical graph diff engine、Issue #74でfile / symbol / type / routeのrename detectionまで実装済みであり、上記の未実装範囲はdiff CLIとgit impactを指す。
