...
- TypeScript exact direct-call graph、closed local candidate `may_call`、external / unresolved call ledger: 実装済み（Issue #43 / #47、2026-07-19 / 2026-07-21）。framework semantic edge / `semantic-complete`は未実装
