...
- component / route / server function semantic edge: Web adapterは実装済み。Next.js / Astro / TanStack Routerのdynamic build境界はIssue #141 / #142 / #143で実装済み、他framework / adapterのbuild観測境界は未実装
