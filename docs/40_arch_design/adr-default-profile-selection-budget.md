...
| ---: | --- | --- | --- | --- |
| 1 | Selection DTO/schema, canonical IDs, ledger, validator, and golden fixture | 2-3 days | This ADR | Rust/core/schema accept only canonical closed plans |
| 2 | Safe inventory size classifier, caps, candidate bounds, and plan digest | 1-2 days | 1 | Boundary fixtures select tiny/small/medium/large deterministically |
