...
| 7 | `profiles plan`, `--profile-budget`, strict profiles-file schema, and v1 config migration | Implemented in #189 | 6 | Explicit requests are all-or-error and auto planning is explainable |
| 8 | Cache/incremental binding and five-target package/release gate | Implemented in #190 | 7 | Plan digest invalidates correctly; Linux/macOS/Windows package tests pass |
