...
- 2026-09-07: Issue #464として事前分割の統合完了条件を[resumable analysis validation](../40_arch_design/resumable-analysis-validation.md)の acceptance matrix と「Epic #464 pre-split integration」節へ記録。公開合成 fixture が個別上限を上げずに scan と health を完了することを子 Issue #465/#463/#467 の evidence gate で照合した（#482 以前は非公開試験対象を maintainer follow-up と誤記）
