...
test("release verification requires the complete 10,000-file metric contract", () => {
  const metricInputs = [
    ["safe_initial_scan", "cold_graph_store", true, [10, 11, 12], 60_000, 30_000],
    [
    ...
    ["cold_file_impact", "first_process_query", false, [1], 3_000, 500],
    ["warm_file_impact", "primed_graph_store", true, [1, 1, 2], 3_000, 500],
    ["cold_package_impact", "first_process_query", false, [1], 3_000, 500],
    [
      "warm_package_impact",
      "primed_graph_store",
      true,
    ...
    ["warm_rust_symbol_query", "primed_graph_store", true, [1], 3_000, 500],
    [
