...
`v0.5.1` provides native packages for Linux x86-64, Linux ARM64, macOS Intel,
...
`main` implements the `0.5.1` contract documented in the
[`v0.5.1` release notes](docs/releases/v0.5.1.md). A stable release is valid
only when the
[`v0.5.1` GitHub Release](https://github.com/TamaT-LLC/depgraph-cli/releases/tag/v0.5.1)
...
See the [`v0.5.1` release notes](docs/releases/v0.5.1.md) for the complete
...
`v0.5.1` becomes the current stable release after the official Release and its
post-publish evidence are public. Until then, `v0.5.0` remains stable and
