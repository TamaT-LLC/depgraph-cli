...
func TestRunVersionAdvertisesAnalysisUnitCapability(t *testing.T) {
	...
	if got, want := stdout.String(), "depgraph-go-worker 0.5.4 (protocol 1.0; capabilities analysis-source-batch-v1,analysis-unit-typed-v1,analysis-loader-scope-v1,analysis-go-package-loader-v1)\n"; got != want {
