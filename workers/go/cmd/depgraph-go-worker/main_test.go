...
func TestRunVersionAdvertisesAnalysisUnitCapability(t *testing.T) {
	...
	if got, want := stdout.String(), "depgraph-go-worker 0.6.1 (protocol 1.0; capabilities analysis-go-package-loader-v1,analysis-loader-scope-v1,analysis-source-batch-v1,analysis-unit-typed-v1)\n"; got != want {
