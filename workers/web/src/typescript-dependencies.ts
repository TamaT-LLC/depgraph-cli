...
export function basisForTargets(targets: readonly TypeScriptRawDependencyTarget[]): TypeScriptRawDependencyEvidence["targetBasis"] {
...
export function callSpecifier(node: CallExpression | NewExpression | TaggedTemplateExpression, sourceFile: SourceFile): string {
