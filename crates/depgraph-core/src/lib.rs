...
mod tests {
    ...
    fn release_compatibility_contract_rejects_drift() {
        ...
        assert_eq!(compatible.stable_release_version, "0.5.2");
        assert_eq!(compatible.previous_release_version, "0.5.1");
