-- Captured with the official v0.4.0-rc.1 aarch64-apple-darwin packaged CLI
-- from tag commit b0848cea4b665da6598a6bf58579c1a1da6a41b2. The packaged
-- binary migrated the official v0.2.0-rc.1 fixture from schema 5 to schema 11;
-- release/scan labels were then normalized to identify this RC upgrade input.
