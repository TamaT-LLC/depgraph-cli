...
mod tests {
    ...
    use super::{
        ...
        verify_mcp_tasks_architecture_decision, verify_pinned_rust_sysroot_digest,
        verify_project_metadata, verify_public_community_surface, verify_release_tag_values,
