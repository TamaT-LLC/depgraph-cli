...
use super::{
    ...
    AGENT_DOGFOOD_REPORT_PATH, AGENT_DOGFOOD_REPORT_SHA256, CURRENT_FULL_CI_RUN_FIXTURE_PATH,
    CURRENT_FULL_CI_RUN_FIXTURE_SHA256, MCP_OPERATION_CONTRACT_VERSION, MCP_TOOL_CONTRACT_VERSION,
    PROJECT_LICENSE_EXPRESSION, PROJECT_LICENSES, RELEASE_TARGETS, RUST_SOURCE_COPYRIGHT,
    RUST_SOURCE_COPYRIGHT_SHA256, RUST_SOURCE_LICENSE_MIT, RUST_SOURCE_LICENSE_MIT_SHA256,
    RUST_SYSROOT_TOOLCHAIN_VERSION, STABLE_RELEASE_BASELINE_STATUS,
...
pub(crate) fn verify_project_metadata(root: &Path) -> Result<()> {
    ...
    for required in [
        ...
        V0_5_RC6_FULL_CI_RUN_FIXTURE_PATH,
        CURRENT_FULL_CI_RUN_FIXTURE_PATH,
    ...
    if sha256_file(&root.join(CURRENT_FULL_CI_RUN_FIXTURE_PATH))?
        != CURRENT_FULL_CI_RUN_FIXTURE_SHA256
    {
        bail!("captured current Full CI API fixture was modified");
    }
